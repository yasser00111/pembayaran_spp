...
<div class="container">
  ...
  <div class="row">
    <div class="col-1">
		...
		<div class="col-1">
			<button type="button" class="badge badge-success p-2 mb-3" data-toggle="modal" data-target="#uploadFileExcel">
...
<div class="modal fade" id="uploadFileExcel" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="staticBackdropLabel">	
			...
			<div class="modal-body">
				<form action="upload-excel.php" method="post" enctype="multipart/form-data">
					<!-- File Excel -->
          <div class="input-group mb-1">
            <span class="input-group-text lebar">File Excel</span>
            <input type="file" name="fileExcel" class="form-control form-control-sm" accept="application/vnd.ms-excel">
          </div>
